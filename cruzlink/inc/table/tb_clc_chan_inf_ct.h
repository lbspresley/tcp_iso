/******************************************************************************
 화일명     : tb_clc_chan_inf_ct.h
 내용설명   : TB_CLC_CHAN_INF c용 Structure
 참고 사항  :
 변경이력   :
     일자             작성자                        내용
  ----------         --------     ---------------------------------------
  2012.04.12                  초기 작성
******************************************************************************/
#ifndef	__TB_CLC_CHAN_INF_CT_H__
#define	__TB_CLC_CHAN_INF_CT_H__
...
typedef	struct
{
	...
	int     tot_ses_cnt;
	int     err_lmt_ses_cnt;
	struct { unsigned short len; unsigned char arr[  1+1]; } chan_prc_dsc;
