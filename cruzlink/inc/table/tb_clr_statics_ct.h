/******************************************************************************
 화일명     : tb_clr_statics_ct.h
 내용설명   : TB_CLR_STATICS c용 Structure
 참고 사항  :
 변경이력   :
     일자             작성자                        내용
  ----------         --------     ---------------------------------------
  2012.04.12                  초기 작성
******************************************************************************/
#ifndef	__TB_CLR_STATICS_CT_H__
#define	__TB_CLR_STATICS_CT_H__
...
typedef	struct
{
	...
	struct { unsigned short len; unsigned char arr[  6+1]; } tr_tm;
